...
class CropsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crop" do
    assert_difference("Crop.count") do
      post crops_url, params: { crop: { expected_harvest: @crop.expected_harvest, name: @crop.name, notes: @crop.notes, planted_on: @crop.planted_on } }
    end
  ...
  test "should update crop" do
    patch crop_url(@crop), params: { crop: { expected_harvest: @crop.expected_harvest, name: @crop.name, notes: @crop.notes, planted_on: @crop.planted_on } }
